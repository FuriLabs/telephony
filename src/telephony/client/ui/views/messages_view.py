...
from telephony.client.utils.model_utils import ConversationItem
...
class MessagesView(Adw.Bin):
    ...
    def update_compose_button(self):
        ...
        run_in_background(self.db.has_conversation, target, on_complete=done)
