...
class TrustedActionsListWindow(Adw.Window):
    ...
    def __init__(self, parent, db, eds, mode="trusted_sms_location_request"):
        ...
        try:
            ...
            elif mode == "trusted_sms_remote_wipe":
                title = _("Set \"SMS Switch Wipe Device\"")
            ...
            if mode == "trusted_sms_location_request":
                ...
                info_text = _(
                    "Trusted contacts can wipe your device. TOTP is mandatory for this feature to work. Add contacts below and set their secret trigger phrase. Example template: 'SECRET TOTP SIM_CURRENT_PIN SIM_NEW_PIN SUDO_PASSWORD' Real life example: 'Gorilla 123456 0000 1234 SupportYourLocalFootball'")
        ...
        if contacts:
            for c in contacts:
                ...
                for ph_num, ph_label in phones:
                    ...
                    row = Adw.ActionRow(
                        title=full_name, subtitle=subtitle_text)
