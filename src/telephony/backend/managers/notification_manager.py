...
class NotificationManager(GObject.Object):
    ...
    def _on_action_invoked(self, conn, sender, path, iface, signal, params, user_data):
        ...
        if target_action and target_action.startswith("app."):
            ...
            if m:
                ...
                if app:
                    app.activate_action(action_name, GLib.Variant("s", param_str))
    ...
    def send_notification(self, id_key, title, body, app_id_hint="io.furios.Telephony", actions=None, priority=1, sound_file=None):
