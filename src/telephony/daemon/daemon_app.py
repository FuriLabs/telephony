...
from telephony.shared.constants import (DAEMON_APP_ID, INCALL_DESKTOP_FILE, CALLS_DESKTOP_FILE, MESSAGES_DESKTOP_FILE)
from telephony.daemon.telephony_core import TelephonyCore
