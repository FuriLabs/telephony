...
from telephony.shared.utils.phone_utils import get_own_number
from telephony.shared.utils.region_utils import detect_region
...
class TelephonyDaemonDBus:
    ...
    def _handle_getcallhistory(self, parameters, invocation):
        ...
        data = [{"id": r[0], "number": r[1], "name": r[2], "direction": r[3], "duration": r[4], "timestamp": r[5], "anonymous": bool(r[6]), "multiparty": bool(r[7]), "transferred": bool(r[8])} for r in rows]
